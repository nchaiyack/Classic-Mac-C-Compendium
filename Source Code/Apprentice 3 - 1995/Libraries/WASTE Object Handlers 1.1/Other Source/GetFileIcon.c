...
static OSErr	GetCustomFileIcon(
/* --> */	FSSpec				*filespec,
/* --> */	IconSelectorValue	iconSelector,
/* <-- */	Handle				*theSuite)
{
...
static OSErr	GetNormalFileIcon(
/* --> */	CInfoPBRec			*cpb,
/* --> */	IconSelectorValue	iconSelector,
/* <-- */	Handle				*theSuite)
{
...
static pascal OSErr GetResourceIcons(
/* <-- */	Handle	*theSuite,
/* --> */	short	theID,
/* --> */	long	theSelector)
{
...
static short	FindGenericIconID(
/* --> */	OSType theType,
/* <-- */	Boolean	*inFinder)
{
...
static pascal OSErr Get1IconSuite(
/* <-- */	Handle	*theSuite,
/* --> */	short	theID,
/* --> */	long	theSelector)
{
