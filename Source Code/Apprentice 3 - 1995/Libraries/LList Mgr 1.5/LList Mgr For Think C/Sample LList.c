...
#define DIALOG_SORT_FWD_ITEM 4
#define DIALOG_SORT_BKWD_ITEM 5
...
void DoSampleLList(Str255 city, Str255 state, Str255 someNumber)
{
	...
	theList->colDesc[2].type = 1;		// if we want to sort column 3 numerically
