...
typedef struct {			// Description of how to draw a column
	...
	short		type;		// 0=ascii text (default), 1=numeric data stored as text
} LColDesc;
...
/*															*/
/************************************************************/
pascal LList *LLNew(Rect *view, WindowPtr window, short rowHeight, short numOfColumns,
					short hasScroll, short selFlags);
...
/*															*/
/************************************************************/
pascal void LLRect(LList *theList, LRow *row, short colFirst, short colLast,
					Rect *theRect);
...
/*															*/
/************************************************************/
pascal short LLSearch(LList *theList, LRow **row, short *colFound, short colFirst,
					short colLast, Ptr data, short dataLen, short ignoreCase);
...
/* To clear a cell, pass 0 and NULL for dataLen and data.	*/
/*															*/
/************************************************************/
...
/* LLSize does not adjust the width of columns, so if		*/
/* listWidth is different from the original width, your 	*/
/* application should make any necessary column width		*/
/* adjustments.												*/
/*															*/
/************************************************************/
...
/* If the type field of the colDesc record for the sort  	*/
/* column is 0 (the default) then comparison on that		*/
/* column is by ascii values. If the type is 1, then 		*/
/* comparison is by numeric values (integer or floating		*/
/* point represented as text).								*/
/*															*/
/************************************************************/
pascal void LLSort(LList *theList, short col1, short col2, short col3, short ignoreCase,
					short order);
