...
resource 'errs' (1130, "operation table", purgeable) {{
	...
	messageOpenURLRez,								messageOpenURLRez, 4;
...
resource 'errs' (1128, "reason table", purgeable) {{
	...
	errOSACantOpenComponent,			errOSACantOpenComponent, 6;
	errTooOldAppleScriptVersion,	errTooOldAppleScriptVersion, 7;
}};
...
resource 'STR#' (kMiscErrorStrings, "kMiscErrorStrings", purgeable) {{
	...
	"AppleScript is not installed";
	"you need AppleScript version 1.1 or later (you have version 1.0 installed)";
}};
...
resource 'STR#' (kTPostErrorStrings, "kTPostErrorStrings", purgeable) {{
	...
	"you have not edited the article (Beware: some editors saves it using another name. Nuntius can't detect that)";
