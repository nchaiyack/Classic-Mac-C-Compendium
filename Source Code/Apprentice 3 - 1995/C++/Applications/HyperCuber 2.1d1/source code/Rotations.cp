...
void BuildRotMatrix(long dim, double *angles, double *matrix);
...
double *CreateRotMatrix(long dim, double *angles)
{
	...
	double *matrix_handle =
			(double *) NewPtr(sizeof(double)*dim*dim);		//  Allocate space for matrix
...
//| Parameters: dim:    the dimension of this rotation
//|             angles: a matrix containing the angles
//|             matrix: handle to the matrix to fill in
//|__________________________________________________________________
...
//|             matrix:    the rotation matrix matrix
