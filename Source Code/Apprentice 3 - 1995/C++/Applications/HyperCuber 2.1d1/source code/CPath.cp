...
CPath::CPath(CPtrArray<RGBColor> *colors) : CPrimitive(colors)
{
...
istream& operator>> (istream& s, CPath& p)
{
	...
	for (i = 1; i <= num_vertices; i++)
		...
		p.path_vertex_indices.Append((long *) vertex_index);	//  Add the vertex to the path
		}
