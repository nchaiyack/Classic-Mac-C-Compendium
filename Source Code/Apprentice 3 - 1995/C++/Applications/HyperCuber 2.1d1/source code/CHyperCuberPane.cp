							...
							SizingOption aHSizing, SizingOption aVSizing)
{
	...
	CreateOffscreenPixmap(&OffscreenPort, &port_bounds);
...
//|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//| CHyperCuberPane::~CHyperCuberPane
//|
...
CHyperCuberPane::~CHyperCuberPane()
{
	...
	DisposeOffscreenPixmap(&OffscreenPort);	//  Dispose of the associated offscreen port
...
void	CHyperCuberPane::AdjustToEnclosure(Rect *deltaEncl)
{
	...
	AdjustOffscreenPixmap(&OffscreenPort,		//  Make offscreen bitmap large enough
								&bounds);
...
void CHyperCuberPane::DoClick(Point hit_point, short modifiers, long when)
{
	...
	MouseTaskStruct	h_mouse_tasks[MAX_MOUSE_CONTROLS];
	MouseTaskStruct	v_mouse_tasks[MAX_MOUSE_CONTROLS];
	short num_h_tasks = 0;
	short num_v_tasks = 0;

	CHyperCuberDoc *doc = (CHyperCuberDoc *) itsSupervisor;	//  Get the document

	long graphic_dimension = graphic->dimension;			//  Find dimension of graphic
