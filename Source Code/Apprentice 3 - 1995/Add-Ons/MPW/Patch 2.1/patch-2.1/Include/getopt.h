/*	Declarations for getopt.
	...
	Modified for Macintosh System 7.5 (MPW) by Christopher E. Hyde 94-05-03
*/
...
// Names for the values of the `has_arg' field of `TOption'.
...
extern int getopt_long (int argc, char* const argv[], const char* shortopts,
						const TOption* longopts, int* longind);
