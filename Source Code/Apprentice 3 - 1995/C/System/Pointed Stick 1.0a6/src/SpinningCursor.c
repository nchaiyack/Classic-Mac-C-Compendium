...
/*******************************************************************************
	...
	donÕt have to worry about calling SpinCursor by hand in the middle of
	calculations or any other lengthy process.

	Before starting the VBL task, we lock down all of the cursor data that
	weÕll access in the task. Next, we we fill out all of the fields of the
...
/*******************************************************************************
	...
	function at regular intervals during a lengthy process. Our Òspin indexÓ
	is incremented by the amount passed in. In keeping with MPWÕs
...
/*******************************************************************************
	...
	our asynchronous cursor spinning routines so that we donÕt keep the data
	locked in memory.
...
/*******************************************************************************
	...
	applicationÕs globals, call SpinCursor to change to the next cursor,
