 ...
 *
 * Compiles under THINK C 6 or 7 or Metrowerks C 4.5
 *
 ...
 *
 * If skelUnivHeaders isn't already defined, this fragment tries to define it
 * based on whether or not the USESROUTINEDESCRIPTORS is defined, since
 * that symbol didn't come into existence until the universal headers were
 * invented.  This can be overridden by making sure skelUnivHeaders is either
 * 1 or 0 before TransSkel.h is processed.
 */
