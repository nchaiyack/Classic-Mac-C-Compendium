...
(game-module (design-notes (
  ...
  "Atomic Games.  V for Victory - Gold-Juno-Sword.  A close-in look at the British side"
  "of the beachhead."
  "Atomic Games.  V for Victory - Utah Beach."
  "Avalon Hill. The Longest Day. (game)  A tour-de-force of design - everyone interested"
  "in recreating the Normandy campaign should own a copy - but with a number of mistakes"
