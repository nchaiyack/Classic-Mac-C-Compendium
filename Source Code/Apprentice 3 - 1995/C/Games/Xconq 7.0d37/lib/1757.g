...
(marshal -20 -5 5 (cp -1) (n "Soubise") (x (appear 10)))

(army -44 -34 6 (hp 22) (cp -1) (x (appear 8)))
(marshal -44 -34 6 (n "Apraxin") (cp -1) (x (appear 8)))
