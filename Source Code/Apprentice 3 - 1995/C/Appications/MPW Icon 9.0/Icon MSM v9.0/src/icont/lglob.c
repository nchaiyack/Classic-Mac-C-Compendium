...
hidden novalue	scanfile	Params((char *filename));
hidden novalue	reference	Params((struct gentry *gp));
 ...
 */
static novalue scanfile(filename)
char *filename;
   {
