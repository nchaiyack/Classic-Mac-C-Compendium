 ...
 */
hidden struct il_code *abstrcomp Params((struct node *n, int indx_stor,
                                    int chng_stor, int escapes));
hidden novalue         abstrsnty Params((struct token *t, int typcd,
...
hidden novalue         chng_ploc Params((int typcd, struct node *src));
 ...
 */
static novalue abstrsnty(t, typcd, indx_stor, chng_stor)
struct token *t;
int typcd;
int indx_stor;
int chng_stor;
