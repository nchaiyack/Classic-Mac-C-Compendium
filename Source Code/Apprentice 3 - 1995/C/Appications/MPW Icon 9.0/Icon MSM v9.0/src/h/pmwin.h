...
/*
 * convert from 1/64 of degrees to 1/65536
 */
#define ANGLE(ang) MAKEFIXED((((ang) >> 6) % 360), (((ang) % 64) << 10))
#define EXTENT(ang) MAKEFIXED((((ang) >> 6) % 360), (((ang) % 64) << 10))
#define FULLARC MAKEFIXED(360, 0)
...
#define StdInRedirect         3
#define OutputToBuf           4
...
#define PMErrInit() { PMFlags |= OutputToBuf; PMStringBufPtr = PMStringBuf; }
