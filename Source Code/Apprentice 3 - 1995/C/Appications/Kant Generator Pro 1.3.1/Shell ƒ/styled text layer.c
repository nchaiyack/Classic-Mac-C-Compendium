...
void StyledInsertStr255(TEHandle hTE, Str255 theStr, short font, short size, Style face)
{
	TextStyle	theStyle;
	...
	theStyle.filler=0x00;
	theStyle.tsColor=myBlackColor;
	TESetStyle(doAll, &theStyle, FALSE, hTE);
	TEInsert(&theStr[1], theStr[0], hTE);
}
