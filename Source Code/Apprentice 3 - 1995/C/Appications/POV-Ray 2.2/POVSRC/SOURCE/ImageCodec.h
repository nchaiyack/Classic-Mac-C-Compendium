...
pascal ComponentResult
CDGetCompressionTime(PREAMBLE,PixMapHandle src,const Rect *srcRect, short depth,CodecQ *spatialQuality,
	CodecQ *temporalQuality,unsigned long *time)
;

pascal ComponentResult
CDGetMaxCompressionSize(PREAMBLE,PixMapHandle src,const Rect *srcRect, short depth,CodecQ quality,long *size)
;
...
pascal ComponentResult
CDGetSimilarity(PREAMBLE,PixMapHandle src,const Rect *srcRect,ImageDescriptionHandle desc,Ptr data,Fixed *similarity)
;
...
pascal ComponentResult
CDRequestSettings(PREAMBLE,Handle settings,Rect *rp,ModalFilterProcPtr filterProc)
;

pascal ComponentResult
CDGetSettings(PREAMBLE,Handle settings)
;

pascal ComponentResult
CDSetSettings(PREAMBLE,Handle settings)
;
