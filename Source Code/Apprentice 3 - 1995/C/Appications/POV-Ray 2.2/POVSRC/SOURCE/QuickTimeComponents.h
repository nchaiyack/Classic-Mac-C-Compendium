...
Created: Tuesday, June 8, 1993 at 3:10 PM
...
pascal ComponentResult SGChannelPutPicture (SGChannel c)  = {0x2F3C,0,0x94,0x7000,0xA82A};
...
#define	scCodecSettingsType		'cdec'		// pointer to Handle
...
pascal ComponentResult MovieImportGetAuxiliaryDataType(MovieImportComponent ci, OSType *auxType) = {0x2F3C,0x4,0xD,0x7000,0xA82A};

pascal ComponentResult MovieImportValidate(MovieImportComponent ci, const FSSpec *theFile, Handle theData, Boolean *valid) = {0x2F3C,0xC,0xE,0x7000,0xA82A};
...
pascal ComponentResult MovieExportSetSampleDescription(MovieExportComponent ci, SampleDescriptionHandle desc, OSType mediaType) = {0x2F3C,0x8,0x85,0x7000,0xA82A};
...
pascal ComponentResult TextExportGetDisplayData(TextExportComponent ci, TextDisplayData *textDisplay) = {0x2F3C,0x4,0x100,0x7000,0xA82A};
