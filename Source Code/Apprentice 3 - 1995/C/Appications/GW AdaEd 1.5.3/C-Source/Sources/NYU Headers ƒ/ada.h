...
#define NUM_LINES	32	// power of 2 to achieve faster calculations [Fabrizio Oddone]



/* Structure definitions */
struct namelistmap {
    int	num;	// align long-sized fields under 68K [Fabrizio Oddone]
    char	*name;
