...

{
    ...
    case P_CLOCK:

        {
            ...
            exec_create(WORDS_TIME_RECORD, &bse, &off, &ptr);
...

        {
            ...
            if ((year % 4) == 0 && month == 2) {
                ...
                if (day > 29) { /* check leap year */
                    ...
                    exec_raise(TIME_ERROR, "Day too large");
            ...
            if (secs >= ONE_DAY) {
                ...
                if (year < 1901 || year > 2099) {
                    ...
                    exec_raise(TIME_ERROR, "Year out of range");
            ...
            exec_create(WORDS_TIME_RECORD, &bse, &off,(int **)(&time_ptr));
    ...
    case P_SUB_TIME_TIME:

        {
            ...
            if (fix_out_of_bounds(dur, (int *)FX_RANGE(dur_tt_ptr)))
                ...
                exec_raise(TIME_ERROR, "Out of range");
...
//    char time_r[35];
    ...
    if (instruction_trace) {
        ...
        sprintf(scrBuffer, "get_time year %d month %d day %d secs %ld secs_chk %ld\n",
