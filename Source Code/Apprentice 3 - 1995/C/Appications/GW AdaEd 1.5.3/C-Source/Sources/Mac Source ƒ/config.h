...
#define	MAC_GWADA	1	// moved here [Fabrizio Oddone]
#define	MAC_AND_PC	1

#define	EXPORT	1	// I managed to compile with this flag set [Fabrizio Oddone]
...
/* Macintosh Version */
 /* WORDSIZE32 or WORDSIZE16 -- whether an "int" is 32 bits or 16 bits */
#define WORDSIZE32
#define OP_SYS "Macintosh System 7"

#if __mc68020__
#define ALIGN4	// 68020 & later and É
#elif __powerc
#define ALIGN4	// É PPCs like this alignment [Fabrizio Oddone]
#else
#define ALIGN2
#endif

#define NULLFILENAME "NULL.file"
#define DIR_DELIMITER ":"

// Other Macintosh compatibility issues
#define unlink remove
#define create creat
		// this was copied from the Unix <ctype.h>
...
//#define TRUE 1
//#define FALSE 0	// these are not needed
...
#else
#define MAX_MEM    (128*1024L) /* maximum words in heap */
#endif
