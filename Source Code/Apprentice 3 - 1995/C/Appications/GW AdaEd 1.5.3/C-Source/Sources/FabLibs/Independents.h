...
UInt32 SetupULongFromPrefs(short ID);
Boolean SetupBooleanFromPrefs(short ID);
void AddString(StringHandle theAddedStr, short strID);
void AddULong(UInt32 theAddedL, short ID);
void AddBoolean(Boolean theAddedL, short ID);
