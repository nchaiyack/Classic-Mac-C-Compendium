...
*/
	 ...
	 *	       |  'call' identifier
	 */
	chaos(__FILE__, __LINE__, "linear(12) not implemented");
#ifdef TBSN
...
static Symbol valid_scalar_instance(Symbol g_name,
Symbol actual_type/*, Symbolmap type_map*/)						/*;valid_scalar_instance*/
{
  ...
  Node name_node)								/*;find_renamed_types*/
{
	...
	default:
		...
		zpnod(name_node);
#endif
		chaos(__FILE__, __LINE__, "unexpected node in find_renamed_types");
	}
	return types;
}
