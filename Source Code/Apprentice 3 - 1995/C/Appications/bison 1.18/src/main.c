...
#ifdef THINK_C  /* then load console routines */
# include <console.h>
#endif
...
{
#ifdef THINK_C
  argc = ccommand( &argv);  /* get arguments on Macintosh */
#endif
  ...
  getargs(argc, argv);	/* process arguments */
  openfiles();
...
#ifdef THINK_C  /* use varargs properly... */
#include <stdarg.h>
