...
/* second menu-item component: Open */
  HMStringItem {
    /* enabled */
    "Opens a text file in a new document window.",
    /* dimmed by application */
    "",
    /* checked */
    "",
...
/* third menu-item component: Close */
  HMStringItem {
    /* enabled */
...
/* fourth menu-item component: Divider */
  HMSkipItem {
    /* no help balloons for divider lines */
    },

/* fifth menu-item component: Save */
  HMStringItem {
    /* enabled */
    "Saves text in current document window.",
    /* dimmed by application */
    "Saves text in current document window. Not available now "
    "because the application does not currently have an "
    "open window.",
    /* checked */
    "",
...
/* sixth menu-item component: Save As */
  HMStringItem {
    /* enabled */
    "Saves text in current document window.",
    /* dimmed by application */
...
/* seventh menu-item component: Divider */
  HMSkipItem {
    /* no help balloons for divider lines */
    },

/* eigth menu-item component: Page Setup */
  HMStringItem {
    /* enabled */
    "Brings up standard Page Setup dialog.",
    /* dimmed by application */
    "",
    /* checked */
    "",
...
/* ninth menu-item component: Print */
  HMStringItem {
    /* enabled */
    "Prints text in current document window.",
    /* dimmed by application */
    "Prints text in current document window. Not available now "
    "because the application does not currently have an "
    "open window.",
    /* checked */
    "",
...
/* tenth menu-item component: Divider */
  HMSkipItem {
    /* no help balloons for divider lines */
    },

/* eleventh menu-item component: Quit */
  HMStringItem {
    /* enabled */
...
/* eigth menu-item component: Select All */
  HMStringItem {
    /* enabled */
    "Selects all text in current window.",
    /* dimmed by application */
    "Selects all text in current window. Not available now "
    "because no text window is currently open.",
    /* checked */
    "",
    /* marked */
    "",
