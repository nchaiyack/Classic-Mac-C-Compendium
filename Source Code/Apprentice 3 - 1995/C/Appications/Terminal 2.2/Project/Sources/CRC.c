/*
	...
	Define symbol SLOW to use the slow, but more space effective function.
	Otherwise the fast function will be used. Execution times for a 1024
	byte block are:

				Mac Plus		Mac IIcx
		slow	118   ms		20.1  ms
		fast	 29.6 ms		 4.70 ms
*/
