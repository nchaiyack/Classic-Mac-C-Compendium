...
void CResourceFile::IResourceFile(CDataFile *aFile)
{
	inherited::ISourceFile(aFile);
	itsKind = H_ResourceFile;
}

int CResourceFile::Compile(void)
{
}

CDataFile *CResourceFile::GetObjectFile(void)
{
	return NULL;
}

unsigned long CResourceFile::GetSourceModDate(void)
{	
	return 0;
}
