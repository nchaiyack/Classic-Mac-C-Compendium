...
/******************************************************************************
 COptionsDialog.c
		...
		A subclass of CDLOGDirector that displays options dialogs.
...
void COptionsDialog::IOptionsDialog( int theID, CDirectorOwner *aSupervisor)
{
	CDLOGDirector::IDLOGDirector( theID, aSupervisor);
}

void
COptionsDialog::DoCommand(long theCommand)
{
	switch (theCommand) {
		default:
