...
void 	InitToolBox( void )
{
	...
	InitMenus();
	TEInit();
	InitDialogs(0L);	// I don't remember if this is supposed to be something elseÉ
	InitCursor();
...
/** Needed for the MovableModal thingÉit breaks a menu code into a menu and a menu item. **/
