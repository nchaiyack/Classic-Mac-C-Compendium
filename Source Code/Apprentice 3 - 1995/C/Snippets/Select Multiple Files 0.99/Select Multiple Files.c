...
/*******************************************************
	...
	primarily on Lloyd LimÕs wonderful method of drawing things in "gray" correctly
	in his "Default" CDEF. He gave me permission to use them here, and for that I am
	indebted! This is the best method IÕve seen for drawing things across multiple
