...
/*******************************************************************************
	...
	weÕll stick in the picture. Next, for each shape, we generate 2 random
	coordinates within our limiting bounds. After that, we choose a random
	shape to create, and use our two points to create it. When weÕve created
...
/*******************************************************************************
	...
	Shows a simple modal dialog. Nothing fancy; itÕs used as a to contrast to
...
/*******************************************************************************
	...
	Given an invisible window that weÕd like to show, this function determines
...
/*******************************************************************************
	...
	to alter only the contents of _our_ windows and no one elseÕs.
...
/*******************************************************************************
	...
	to be the main device. Otherwise, do nothing, as GDevices arenÕt
...
/*******************************************************************************
	...
	hand. In this little sample, we donÕt support the creation of color
	offscreen buffers on Color QuickDraw machines that donÕt have the GWorld
	routines.
...
/*******************************************************************************
	...
	globalRgn, translate that copy into the windowÕs local coordinate system,
