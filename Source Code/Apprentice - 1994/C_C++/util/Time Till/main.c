/***************************************************************************************************
	main.c
		...
		Source code for the 'Time Till' application.
...
/***************************************************************************************************
	MakeRelativeTimeString
		...
		The Ònn DaysÓ portion of the string is only outputted if the time is greater
		than one day.
...
static Boolean GetTargetDate(long *targetDate)
{
	...
	// Should check for an error hereÉ
	SetPort(theDialog);
