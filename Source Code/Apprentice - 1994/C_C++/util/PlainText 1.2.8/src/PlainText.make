...
PlainText ÄÄ PlainText.make PlainText.r
	Rez "{RIncludes}"Types.r ¶
		"{RIncludes}"SysTypes.r ¶
		PlainText.r ¶
		-append -o PlainText

PlainText ÄÄ PlainText.make PTHeaders {OBJECTS}
...
PTGlobs.h Ä PlainText.make PTRoot.c
	 MakeExtern PTRoot.c PTGlobs.h
	 
PTHeaders Ä BuildPTHeaders.c PTGlobs.h PlainText.h
	C {COptions} BuildPTHeaders.c
	
:obj:PTRoot.c.o Ä PlainText.make PTRoot.c
	 C {COptions} PTRoot.c -o :obj:PTRoot.c.o
:obj:PlainText.c.o Ä PlainText.make PTRoot.c PlainText.c
	 C {COptions} PlainText.c -o :obj:PlainText.c.o
:obj:PTDocs.c.o Ä PlainText.make PTGlobs.h PTDocs.c
	 C {COptions} PTDocs.c -o :obj:PTDocs.c.o
:obj:PTConverts.c.o Ä PlainText.make PTGlobs.h PTConverts.c
	 C {COptions} PTConverts.c -o :obj:PTConverts.c.o
:obj:Acurs.c.o Ä PlainText.make Acurs.c
	 C {COptions} -d NOMMAIN=1 -o :obj:Acurs.c.o Acurs.c
:obj:TE32K.c.o Ä PlainText.make TE32K.c
