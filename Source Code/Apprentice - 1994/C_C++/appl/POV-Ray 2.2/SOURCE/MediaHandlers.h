...
pascal ComponentResult MediaGetOffscreenBufferSize (ComponentInstance ci, Rect *bounds, short depth, CTabHandle ctab )
	= {0x2F3C,0xA,0x51B,0x7000,0xA82A};
pascal ComponentResult MediaSetHints (ComponentInstance ci, long hints )
	= {0x2F3C,0x4,0x51C,0x7000,0xA82A};
pascal ComponentResult MediaGetName (ComponentInstance ci, Str255 name, long requestedLanguage, long *actualLanguage )
	= {0x2F3C,0xC,0x51D,0x7000,0xA82A};
