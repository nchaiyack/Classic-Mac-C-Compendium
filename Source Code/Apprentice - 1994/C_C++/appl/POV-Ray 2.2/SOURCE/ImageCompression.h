...
pascal OSErr
DecompressSequenceBeginS(ImageSequence *seqID,ImageDescriptionHandle desc,Ptr data,long dataSize,
		CGrafPtr port,GDHandle gdh,const Rect *srcRect,MatrixRecordPtr matrix,
		short mode,RgnHandle mask,CodecFlags flags,CodecQ accuracy,DecompressorComponent codec)
...
pascal OSErr
SetSequenceProgressProc(ImageSequence seqID, ProgressProcRecord *progressProc)
	= {0x203C,0x8,0x56,0xAAA3};

pascal OSErr
GDHasScale(GDHandle gdh,short depth,Fixed *scale)
	= {0x203C,0xA,0x5A,0xAAA3};

pascal OSErr
GDGetScale(GDHandle gdh,Fixed *scale,short *flags)
	= {0x203C,0xC,0x5B,0xAAA3};

pascal OSErr
GDSetScale(GDHandle gdh,Fixed scale,short flags)
	= {0x203C,0xA,0x5C,0xAAA3};
