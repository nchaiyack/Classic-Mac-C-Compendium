	...
	switch (item_hit)
		...
		case OKAY_BUTTON:
			...
			if (!(is_valid_param_int(animation_dialog, NUM_FRAMES_NUM, NUM_FRAMES_LABEL,
				...
				SetItem(file_menu, SAVE_ITEM, "\pSave AnimationÉ");
		...
		case CANCEL_BUTTON:
			...
			SetItem(file_menu, SAVE_ITEM, "\pSave ImageÉ");
...
void handle_checkbox_click(ControlHandle check_box)
{
	...
	if (check_box == animate_checkbox)
		...
		SetItem(file_menu, SAVE_ITEM, (current_value) ? "\pSave ImageÉ" : "\pSave AnimationÉ");
