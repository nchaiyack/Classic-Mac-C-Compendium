/*****************************************************************************
* 
*			  NCSA HDF version 3.10r4
*				June 25, 1991
*
* NCSA HDF Version 3.10r4 source code and documentation are in the public
...
*****************************************************************************/
#ifdef RCSID
static char RcsId[] = "@(#)$Revision: 3.16 $"
#endif
/*
$Header: /pita/work/HDF/dev/RCS/src/dfi.h,v 3.16 91/06/21 11:56:26 dilg beta $
$Log:	dfi.h,v $
 * Revision 3.16  91/06/21  11:56:26  dilg
 * Removed malloc() from the #ifndef UNICOS at the end of the file.
 * 
 * Revision 3.15  91/05/21  12:25:57  dilg
 * Changed #include <sys/fcntl.h> to #include <fcntl.h> in UNICOS section and
 * put #ifndef UNICOS - #endif around redefinitions of strncpy(), strcpy(),
 * malloc(), and memcpy() at end of file.  Needed because of change to 
 * UNICOS 6.X.
 * 
