...
{	
	...
	fprintf(f, "#define arch_align_short_mod %ld\n",
		(char *)&ss.s - &ss.c);
	fprintf(f, "#define arch_align_long_mod %ld\n",
		(char *)&sl.l - &sl.c);
	fprintf(f, "#define arch_align_float_mod %ld\n",
		(char *)&sf.f - &sf.c);
	fprintf(f, "#define arch_align_double_mod %ld\n",
		(char *)&sd.d - &sd.c);
