...
resource 'CMNU' (mFile) {
	...
	"File",
	{
		...
		"-",										noIcon,	noKey,	noMark,	plain,	nocommand;
		"Extract binaries as…",	noIcon, "E",		noMark,	plain,	cExtractBinaries;
		"-",										noIcon,	noKey,	noMark,	plain,	nocommand;
...
resource 'CMNU' (mArticles) {
	...
	"Articles",
	{
		...
		"-",																			noIcon,	noKey, noMark, plain,	nocommand;
		"Save selection in the notes",						noIcon, "T",   noMark, plain, cStoreNotes;
...
/* ------------------------------------------------------------------------------ */
resource 'CMNU' (mNewsServerTranslateMenu) {
	mNewsServerTranslateMenu,
	textMenuProc,
	allEnabled,
	enabled,
	"mNewsServerTranslateMenu",
...
/* ------------------------------------------------------------------------------ */
resource 'STR#' (kDynamicMenuItemNames, "kDynamicMenuItemNames") {{
	"Extract binaries";
	"Extract binaries as…";
	"Extract binaries as multiple documents";
	"Extract binaries as multiple documents as…";
}};
