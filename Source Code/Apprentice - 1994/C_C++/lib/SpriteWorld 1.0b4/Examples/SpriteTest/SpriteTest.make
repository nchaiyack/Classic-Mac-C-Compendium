...
SpriteTest ÄÄ SpriteTest.make {OBJECTS}
	Link -t APPL -c '????' ¶
		{OBJECTS} ¶
		"{Libraries}"Runtime.o ¶
...
SpriteTest ÄÄ SpriteTest.r SpriteTest.¹.rsrc
	rez SpriteTest.r -a -o SpriteTest

"{SWObjectDir}Frame.c.o" Ä "{SWSourceDir}Frame.c" "{SWHeaderDir}Frame.h"
	C "{SWSourceDir}Frame.c" {COptions} -o "{SWObjectDir}Frame.c.o"

"{SWObjectDir}Sprite.c.o" Ä "{SWSourceDir}Sprite.c" "{SWHeaderDir}Sprite.h"
	C "{SWSourceDir}Sprite.c" {COptions} -o "{SWObjectDir}Sprite.c.o"

"{SWObjectDir}SpriteLayer.c.o" Ä "{SWSourceDir}SpriteLayer.c" "{SWHeaderDir}SpriteLayer.h"
	C "{SWSourceDir}SpriteLayer.c" {COptions} -o "{SWObjectDir}SpriteLayer.c.o"

"{SWObjectDir}SpriteWorld.c.o" Ä "{SWSourceDir}SpriteWorld.c" "{SWHeaderDir}SpriteWorld.h"
	C "{SWSourceDir}SpriteWorld.c" {COptions} -o "{SWObjectDir}SpriteWorld.c.o"

"{SWObjectDir}SpriteWorldUtils.c.o" Ä "{SWSourceDir}SpriteWorldUtils.c" "{SWHeaderDir}SpriteWorldUtils.h"
	C "{SWSourceDir}SpriteWorldUtils.c" {COptions} -o "{SWObjectDir}SpriteWorldUtils.c.o"

"{SWObjectDir}SpriteCompiler.c.o" Ä "{SWSourceDir}SpriteCompiler.c" "{SWHeaderDir}SpriteCompiler.h"
	C "{SWSourceDir}SpriteCompiler.c" {COptions} -o "{SWObjectDir}SpriteCompiler.c.o"

"{SWObjectDir}BlitPixie.c.o" Ä "{SWSourceDir}BlitPixie.c" "{SWHeaderDir}BlitPixie.h"
	C "{SWSourceDir}BlitPixie.c" {COptions} -o "{SWObjectDir}BlitPixie.c.o"

"{UtilsDir}DialogUtils.c.o" Ä "{UtilsDir}DialogUtils.c" "{UtilsDir}DialogUtils.h"
	C "{UtilsDir}DialogUtils.c" {COptions} -o "{UtilsDir}DialogUtils.c.o"

"{UtilsDir}DebugUtils.c.o" Ä "{UtilsDir}DebugUtils.c" "{UtilsDir}DebugUtils.h"
	C "{UtilsDir}DebugUtils.c" {COptions} -o "{UtilsDir}DebugUtils.c.o"

"{UtilsDir}StringUtils.c.o" Ä "{UtilsDir}StringUtils.c" "{UtilsDir}StringUtils.h"
	C "{UtilsDir}StringUtils.c" {COptions} -o "{UtilsDir}StringUtils.c.o"

"{UtilsDir}GameUtils.c.o" Ä "{UtilsDir}GameUtils.c" "{UtilsDir}GameUtils.h"
	C "{UtilsDir}GameUtils.c" {COptions} -o "{UtilsDir}GameUtils.c.o"

"{SpriteTestObjectDir}About.c.o" Ä About.c About.h
	C "About.c" {COptions} -o "{SpriteTestObjectDir}About.c.o"

"{SpriteTestObjectDir}Application.c.o" Ä Application.c Application.h
	C "Application.c" {COptions} -o "{SpriteTestObjectDir}Application.c.o"

"{SpriteTestObjectDir}SpriteTest.c.o" Ä SpriteTest.c SpriteTest.h
