...
//	#include "LuminanceRecord1.h" 						/* get defaults from old calibration */
	...
	if(i>0)printf("Successfully read old Ò%sÓ to set default values.\n",string);
	else{
		printf("Couldn't find an old copy of Ò%sÓ; creating new one from scratch.\n",string);
	...
	LP->dacSize=GDDacSize(device);			// Takes 200 µs.
