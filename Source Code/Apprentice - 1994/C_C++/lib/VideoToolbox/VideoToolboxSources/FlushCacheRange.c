...
****************************************************************************
NOTE: This routine was distributed by Apple on their Developer Disk for May, 1992.
I changed the name of the file from Cache.c to FlushCacheRange.c, to match the
name of the routine, moved the prototype from Cache.h to VideoToolbox.h,
and pasted the contents of the "About..." file above. Otherwise the file is unchanged.
You might need licensing from Apple to use this in a commercial application.
Denis Pelli, July, 1992
****************************************************************************
 *
