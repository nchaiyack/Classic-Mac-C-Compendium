...
static char				RawExclamationIcon[] =
	{
...
static char				RawSpeechIcon[] =
	{
		0x00,0x0F,0xF0,0x00,0x00,0x7F,0xFE,0x00,0x01,0xF0,0x0F,0x80,0x03,0xC0,0x03,0xC0,
		0x07,0x1F,0xF8,0xE0,0x0E,0x07,0xE0,0x70,0x1C,0x03,0xC0,0x38,0x38,0x03,0xC0,0x1C,
		0x30,0x03,0xC0,0x0C,0x70,0x03,0xC0,0x0E,0x60,0x03,0xC0,0x06,0x60,0x03,0xC0,0x06,
		0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,
		0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,0xC0,0x03,
		0x60,0x03,0xC0,0x06,0x60,0x03,0xC0,0x06,0x70,0x03,0xC0,0x0E,0x30,0x03,0xC0,0x0C,
		0x38,0x03,0xC0,0x1C,0x1C,0x03,0xC0,0x38,0x0E,0x07,0xE0,0x70,0x07,0x1F,0xF8,0xE0,
...
static void				AlertUpdater(AlertRec* Window)
	{
		...
		DrawWrappedTextBox(Window->ScreenID,Window->TotalMessage,GetUglyFont(),12,
			23 + 32 + 23,13,ALERTWIDTH - (23 + 32 + 23 + 13),
...
static void				LocalAlert(Bitmap* TheIcon, char* Message, char* ExtraInfo)
	{
		...
		Window.ScreenID = MakeNewWindow(eDialogWindow,eWindowNotClosable,eWindowNotZoomable,
			eWindowNotResizable,AlertLeftEdge(ALERTWIDTH),AlertTopEdge(ALERTHEIGHT),
			ALERTWIDTH,ALERTHEIGHT,(void (*)(void*))&AlertUpdater,&Window);
...
YesNoCancelType		AskYesNoCancel(char* Message, char* ExtraInfo,
										char* Yes, char* No, char* Cancel)
	{
		...
		SetArrowCursor();
		Window.ScreenID = MakeNewWindow(eDialogWindow,eWindowNotClosable,eWindowNotZoomable,
			eWindowNotResizable,DialogLeftEdge(DLOGWIDTH),DialogTopEdge(DLOGHEIGHT),
			DLOGWIDTH,DLOGHEIGHT,(void (*)(void*))&YesNoCancelUpdater,&Window);
