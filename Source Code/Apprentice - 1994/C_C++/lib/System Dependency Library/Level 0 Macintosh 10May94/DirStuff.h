...
/* Note:  This library depends on FileSpec == FSSpec.  If Files decides to */
/* change this, then it must be changed here as well. */
struct FileSpec;
...
typedef enum {eFile, eSymbolicLink, eDirectory, eOther} DirFileTypes;
