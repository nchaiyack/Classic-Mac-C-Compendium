...
void startupCStrs(void)
{
	...
	gMiscCStr[2] = "expected an identifier or a dcl but didnÕt find one.";
	gMiscCStr[3] = "didnÕt find a variable name.";
	gMiscCStr[4] = "couldnÕt find a type specifier (ANSI, unlike K&R 1st ed., requires one).";
	gMiscCStr[5] = "syntax error.";
	gMiscCStr[6] = "array syntax error.";
	gMiscCStr[7] = "the English output string is too long. (!)";
	gMiscCStr[8] = "function prototypes are nested too deep (my faultÑsorry).";
	gMiscCStr[9] = "a function cannot return an actual functionÑtry a function pointer instead, maybe.";
	gMiscCStr[10] = "a function cannot return an actual arrayÑtry a pointer instead, maybe.";
	gMiscCStr[11] = "an arrayÕs element type cannot be an actual functionÑtry a pointer to function instead, maybe.";
	gMiscCStr[12] = "A Mac OS error occurred. Your lucky number for today is ";
	gMiscCStr[13] = ".";
	gMiscCStr[14] = "The variable named Ò";
	gMiscCStr[15] = "Ó is of type Ò";
	gMiscCStr[16] = ".Ó";
	gMiscCStr[17] = " ";
