...
File:		Skipaline U-D 2-pass reversed.c
...
pascal short Skipaline2PassReversed(GrafPtr sourceGrafPtr, GrafPtr destGrafPtr, Rect boundsRect);
...
pascal short Skipaline2PassReversed(GrafPtr sourceGrafPtr, GrafPtr destGrafPtr, Rect boundsRect)
{
	...
	while (thatone.bottom>=boundsRect.top)
	{
		StartTiming();
