...
void PrefsError(int err)
{
	...
	{
		case diskReadErr:
			ParamText("\pThe DevilÕs Cubes preferences file could not be accessed, because a \
...
in the trash.","\p","\p","\p");
		...
		case cantCreatePrefsErr:
			ParamText("\pThe DevilÕs Cubes preferences file could not be created.  The \
disk may be locked or full.  Default preferences will be used for now.","\p","\p","\p");
			break;
		case cantOpenPrefsErr:
			ParamText("\pThe DevilÕs Cubes preferences file could not be accessed.  The \
...
by a later version of DevilÕs Cubes than this copy.  If you want to be able to save your \
