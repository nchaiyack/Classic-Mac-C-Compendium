...
pascal short SplitScrollUDFade(Rect boundsRect, Pattern *thePattern)
{
	...
	SetRectRgn(temprgn, topdest.left, topdest.top, topdest.right, topdest.bottom);
	SectRgn(toprgn, temprgn, topsectrgn);
	
	SetRectRgn(temp2rgn, bottomdest.left, bottomdest.top, bottomdest.right, bottomdest.bottom);
