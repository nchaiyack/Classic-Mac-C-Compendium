		...
		else
		{
			...
			if (index>=gNumHumanPlayers)
			{
				...
				else if (gStatus==kJustGotALetter)
				{
					...
					{
						case 0x01:	AddToMessage("\p gets a ÒGÓ !"); break;
						case 0x02:	AddToMessage("\p gets an ÒHÓ !"); break;
						case 0x03:	AddToMessage("\p gets an ÒOÓ !"); break;
						case 0x04:	AddToMessage("\p gets an ÒSÓ !"); break;
