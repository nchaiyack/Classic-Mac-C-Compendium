...
File:		v file management.h

Purpose:	This is the header file for v file management.c
...
int GetBuffer(int fileRefNum, unsigned long offset, unsigned char output[256]);
