...
void PrefsError(int err)
{
	switch (err)
	{
		case prefs_diskReadErr:
			ParamText("\pThe Voyeur preferences file could not be accessed, because a \
...
in the trash.","\p","\p","\p");
		...
		case prefs_cantCreatePrefsErr:
			ParamText("\pThe Voyeur preferences file could not be created.  The \
disk may be locked or full.  Default preferences will be used for now.","\p","\p","\p");
			break;
		case prefs_cantOpenPrefsErr:
			ParamText("\pThe Voyeur preferences file could not be accessed.  The \
...
by a later version of Voyeur than this copy.  If you want to be able to save your \
