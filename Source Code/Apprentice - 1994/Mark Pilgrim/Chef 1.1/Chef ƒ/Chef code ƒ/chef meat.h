...
Purpose:	This is the header file for chef meat.c
...
void ConvertIt(void);					/* main dispatch */
char ThisChar(void);					/* current char */
char NextChar(int howmany);				/* howmany-th char after current char */
Boolean IsAlpha(char thisChar);			/* TRUE if thisChar is in A-Z or a-z */
Boolean IsUpperAlpha(char thisChar);	/* TRUE if thisChar is in A-Z */
