...
Purpose:	This module handles fatal and non-fatal Jotto-specific
			errors.
...
void HandleError(int resultCode)
{
	...
	if (resultCode!=allsWell)
	{
		...
		switch (resultCode)
		{
			...
			case kCantGetFiveLetterComputerWord:
			case kCantGetSixLetterComputerWord:
			case kCantGetFiveLetterHumanWord:
			case kCantGetSixLetterHumanWord:
			case kCantGetFiveLetterCustomWord:
			case kCantGetSixLetterCustomWord:
				ShutDownEnvironment();
				ExitToShell();
				break;
		}
