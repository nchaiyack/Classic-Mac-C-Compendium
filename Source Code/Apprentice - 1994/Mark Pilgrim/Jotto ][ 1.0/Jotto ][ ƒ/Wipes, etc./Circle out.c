...
void CircleOut(GrafPtr sourceGrafPtr, GrafPtr destGrafPtr, int theWindowHeight, int theWindowWidth)
{
	Rect		theRect;
	int			cx, cy;
	RgnHandle	curregion;
	...
	while (theRect.right-theRect.left<=425);   /* (2 x || (cx,cy) ||) + a little */
