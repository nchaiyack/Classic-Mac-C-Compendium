...
//¥ Ported to Think Cª on 22 June 1993 By Kenneth A.Long.
...
void Set_Up_Window (void)
{
	...
	DrawString ("\pThinkPascal Code by Eddy Vasile. Plot Points from anonymous source.");
	MoveTo (40, 310);
	TextSize (12);
	TextFace (bold);

	DrawString ("\pPorted to Think Cª v5.0.4 by Ken Long, 22 June 1993");
	PenNormal ();
